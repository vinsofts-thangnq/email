...
<head>
    ...
    <script src="../asset-email/ckeditor/ckeditor.js"></script> 
</head>
...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
            ...
            <!-- Table -->
            <form class="form-horizontal form-label-left" method="post" action="{{ url('update/'.$data->id) }}" >
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    ...
                    <input class="form-control col-md-7 col-xs-12"  name="subject" type="text" value="{{$data->subject}}">
                </div>

                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    <label >Title <span class="required">*</span></label>
                    <input  class="form-control col-md-7 col-xs-12"  name="title" type="text" value="{{$data->title}}">
                </div>

                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    <label >Color <span class="required">*</span></label>
                    <input class="col-md-12 col-sm-12 col-xs-12 form-group" name="color" type="color" value="{{$data->title}}" style="height: 40px">

                </div>

                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    <label>From <span class="required">*</span></label>
                    <select class="form-control" name="email_templates">
                        <option value="accounting@caza.vn" <?php if($data->email_templates==="accounting@caza.vn") echo "selected"?>>accounting@caza.vn</option>
                        <option value="hello@caza.vn" <?php if($data->email_templates==="hello@caza.vn") echo "selected"?>>hello@caza.vn</option>
                    </select>
                </div>

                <div class="col-md-6 col-sm-6 col-xs-6 form-group">
                    <label>Email người nhận <span class="required">*</span></label>
                    <input class="form-control col-md-7 col-xs-12"  name="" type="text" value="">
                </div>

                <div class="col-md-6 col-sm-6 col-xs-6 form-group">
                    <label>Email người được Bcc <span class="required">*</span></label>
                    <input class="form-control col-md-7 col-xs-12"  name="" type="text" value="">
                </div>
...
<!-- scrip -->
    ...
    <script src="../asset-email/ckeditor/ckeditor.js" type="text/javascript"></script>
